...
// Mira's Supabase — separate from main agentsv2 project
// Read-only public data, safe to hardcode
...
export default function MiraPage() {
  ...
  async function loadCycles() {
    console.log('Loading cycles from:', process.env.NEXT_PUBLIC_SUPABASE_URL)
